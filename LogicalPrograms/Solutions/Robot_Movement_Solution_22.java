...
public class Robot_Movement_Solution_22{
 ...
 /* Integer[] result = {0, 0};
  ...
  return result;*/
	/*  
	  ...
	  for(char ch:path.toCharArray()) {
		  switch(ch) {
		  case 'U':result[1] = result[1]+1; break;
		  case 'D':result[1]  = result[1]-1; break;
		  case 'L': result[0]  = result[0]-1; break;
		  case 'R': result[0]  = result[0]+1; break;
		  default:break;
		  }
	  }
	  return result;*/
